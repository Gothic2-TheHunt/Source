...
const int SPL_Cost_TrfGiantBug = 15;
const int SPL_Cost_TrfWolf = 15;
const int SPL_Cost_TrfWaran = 20;
const int SPL_Cost_TrfSnapper = 30;
const int SPL_Cost_TrfWarg = 40;
const int SPL_Cost_TrfFireWaran = 50;
const int SPL_Cost_TrfLurker = 25;
const int SPL_Cost_TrfShadowbeast = 50;
const int SPL_Cost_TrfDragonSnapper = 75;
...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfScavenger))
	{
...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfGiantRat))
	{
...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfGiantBug))
	{
...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfWolf))
	{
...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfWaran))
	{
...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfFireWaran))
	{
...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfLurker))
	{
...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_TrfDragonSnapper))
	{
