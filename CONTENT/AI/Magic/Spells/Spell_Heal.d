...
const int SPL_Cost_LightHeal = 15;
const int SPL_Cost_MediumHeal = 30;
const int SPL_Cost_FullHeal = 60;
...
{
	if(Npc_GetActiveSpellIsScroll(self) && (self.attribute[ATR_MANA] >= SPL_Cost_Scroll_Circle1))
	{
		return SPL_SENDCAST;
	}
...
func void Spell_Cast_Heal()
{
	if(Npc_GetActiveSpell(self) == SPL_LightHeal)
	{
		...
		{
			self.attribute[ATR_MANA] = self.attribute[ATR_MANA] - SPL_Cost_Scroll_Circle1;
		}
		else
		{
