...
const int AIV_DragonTimer = 89;
const int AIV_SummonPoints = 90;
...
const int FIGHT_DIST_DRAGON_MAGIC = 600;
const int MONSTER_THREATEN_TIME = 4;
const int MONSTER_SUMMON_TIME = 120;
...
const int FAI_HUMAN_PERFECT = 47;
