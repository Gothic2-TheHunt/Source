...
const int Value_Sc_PalLightHeal = 30;
const int Value_Sc_PalHolyBolt = 100;
const int Value_Sc_PalMediumHeal = 75;
const int Value_Sc_PalRepelEvil = 200;
const int Value_Sc_PalFullHeal = 150;
const int Value_Sc_PalDestroyEvil = 300;
const int Value_Sc_Light = 10;
const int Value_Sc_Firebolt = 25;
const int Value_Sc_Charm = 100;
const int Value_Sc_Icebolt = 45;
const int Value_Sc_LightHeal = 30;
const int Value_Sc_SumGobSkel = 35;
const int Value_Sc_InstantFireball = 50;
const int Value_Sc_Zap = 25;
const int Value_Sc_SumWolf = 70;
const int Value_Sc_Windfist = 50;
const int Value_Sc_Sleep = 75;
const int Value_Sc_MediumHeal = 75;
const int Value_Sc_LightningFlash = 125;
const int Value_Sc_ChargeFireball = 150;
const int Value_Sc_SumSkel = 125;
const int Value_Sc_Fear = 85;
const int Value_Sc_IceCube = 150;
const int Value_Sc_ThunderBall = 125;
const int Value_Sc_SumGol = 200;
const int Value_Sc_HarmUndead = 150;
const int Value_Sc_Pyrokinesis = 250;
const int Value_Sc_Firestorm = 100;
const int Value_Sc_IceWave = 200;
const int Value_Sc_SumDemon = 300;
const int Value_Sc_FullHeal = 150;
const int Value_Sc_Firerain = 350;
const int Value_Sc_BreathOfDeath = 250;
const int Value_Sc_MassDeath = 350;
const int Value_Sc_ArmyOfDarkness = 300;
const int Value_Sc_Shrink = 200;
const int Value_Sc_TrfSheep = 25;
const int Value_Sc_TrfScavenger = 35;
const int Value_Sc_TrfGiantRat = 30;
const int Value_Sc_TrfGiantBug = 50;
const int Value_Sc_TrfWolf = 75;
const int Value_Sc_TrfWaran = 100;
...
instance ItSc_PalLight(C_Item)
{
	...
	cond_value[2] = SPL_Cost_Scroll_Circle1;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER";
	description = NAME_SPL_PalLight;
	text[0] = Name_PaladinScroll;
	text[1] = NAME_Mana_needed;
	count[1] = SPL_Cost_Scroll_Circle1;
...
{
	name = NAME_SCROLL_PalMediumHeal;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
{
	name = NAME_SCROLL_PalDestroyEvil;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
instance ItSc_Firebolt(C_Item)
{
	...
	text[3] = NAME_Weak_Against_Humans;
	text[5] = NAME_Value;
	count[5] = value;
};
...
{
	name = NAME_SCROLL_SummonGoblinSkeleton;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
{
	name = NAME_SCROLL_InstantFireball;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
{
	name = NAME_SCROLL_LightningFlash;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
{
	name = NAME_SCROLL_ChargeFireball;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
{
	name = NAME_SCROLL_SummonSkeleton;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
{
	name = NAME_SCROLL_DestroyUndead;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
instance ItSc_IceWave(C_Item)
{
	...
	spell = SPL_IceWave;
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_Cost_Scroll_Circle6;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_BLUE";
	description = NAME_SPL_IceWave;
	text[0] = NAME_MageScroll;
	text[1] = NAME_Mana_needed;
	count[1] = SPL_Cost_Scroll_Circle6;
	text[2] = NAME_Dam_Magic;
	count[2] = 60;
	text[3] = NAME_Sec_Duration;
	count[3] = SPL_TIME_FREEZE;
...
{
	name = NAME_SCROLL_BreathOfDeath;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
instance ItSc_MassDeath(C_Item)
{
	...
	spell = SPL_MassDeath;
	cond_atr[2] = ATR_MANA_MAX;
	cond_value[2] = SPL_Cost_Scroll_MasDeath;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_WEAKGLIMMER_RED";
	description = NAME_SPL_MassDeath;
	text[0] = NAME_MageScroll;
	text[1] = NAME_Mana_needed;
	count[1] = SPL_Cost_Scroll_MasDeath;
	text[2] = NAME_Dam_Magic;
...
{
	name = NAME_SCROLL_ArmyOfDarkness;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
{
	name = NAME_SCROLL_TrfShadowbeast;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
...
{
	name = NAME_SCROLL_TrfDragonSnapper;
	mainflag = ITEM_KAT_RUNE;
	flags = ITEM_MULTI;
