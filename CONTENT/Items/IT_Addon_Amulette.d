...
const int Value_ItAm_Addon_Franco = 1500;
const int HP_ItAm_Addon_Franco = 30;
const int STR_Franco = 4;
const int DEX_Franco = 4;
const int Value_ItRi_Addon_Health_01 = 600;
const int Value_ItAm_Addon_Health = 1200;
const int Value_ItRi_Addon_Mana_01 = 450;
const int Value_ItAm_Addon_Mana = 900;
const int Value_ItRi_Addon_STR_01 = 500;
const int Value_ItAm_Addon_STR = 1000;
const int HP_Ring_Solo_Bonus = 25;
const int HP_Ring_Double_Bonus = 60;
const int HP_Amulett_Solo_Bonus = 40;
const int HP_Amulett_EinRing_Bonus = 80;
const int HP_Amulett_Artefakt_Bonus = 130;
const int MA_Ring_Solo_Bonus = 15;
const int MA_Ring_Double_Bonus = 40;
const int MA_Amulett_Solo_Bonus = 25;
const int MA_Amulett_EinRing_Bonus = 50;
const int MA_Amulett_Artefakt_Bonus = 80;
...
const int STR_Amulett_Artefakt_Bonus = 30;
...
func void Equip_ItAm_Addon_STR()
{
	...
	Npc_ChangeAttribute(self,ATR_STRENGTH,(NewValue - OldValue));
