...
const int Value_Wolfsklinge = 175;
const int Damage_ShortSword2 = 30;
const int Condition_ShortSword2 = 15;
...
const int Damage_Bau2hAxt = 55;
const int Condition_Bau2hAxt = 45;
const int Range_Bau2hAxt = 70;
const int Value_Bau2hAxt = 500;
const int Damage_Spitzhacke = 35;
const int Condition_Spitzhacke = 15;
const int Range_Spitzhacke = 60;
const int Value_Spitzhacke = 300;
const int Damage_MiscSword = 30;
const int Condition_MiscSword = 25;
const int Range_MiscSword = 70;
const int Value_MiscSword = 50;
const int Damage_MiscAxe = 45;
const int Condition_MiscAxe = 30;
const int Range_MiscAxe = 80;
const int Value_MiscAxe = 60;
...
const int Damage_MilSchwert = 45;
const int Condition_MilSchwert = 40;
const int Range_MilSchwert = 90;
const int Value_MilSchwert = 250;
const int Damage_Sld1hAxt = 45;
const int Condition_Sld1hAxt = 45;
const int Range_Sld1hAxt = 70;
const int Value_Sld1hAxt = 90;
const int Damage_Sld1hSchwert = 35;
const int Condition_Sld1hSchwert = 30;
const int Range_Sld1hSchwert = 70;
const int Value_Sld1hSchwert = 65;
const int Damage_Sld2hAxe = 60;
const int Condition_Sld2hAxe = 55;
const int Range_Sld2hAxe = 80;
const int Value_Sld2hAxe = 135;
...
const int Value_Sld2hSchwert = 140;
const int Damage_PIR2hAxe = 85;
const int Condition_PIR2hAxe = 70;
const int Range_PIR2hAxe = 90;
const int Value_PIR2hAxe = 800;
const int Damage_PIR2hSword = 90;
const int Condition_PIR2hSword = 80;
const int Range_PIR2hSword = 120;
const int Value_PIR2hSword = 900;
...
const int Condition_PIR1hSword = 65;
const int Range_PIR1hSword = 70;
const int Value_PIR1hSword = 750;
const int Damage_PalSchwert = 60;
const int Condition_PalSchwert = 55;
const int Range_PalSchwert = 70;
const int Value_PalSchwert = 600;
const int Damage_PalZweihaender = 85;
const int Condition_PalZweihaender = 75;
...
const int Value_ShortSword4 = 300;
const int Damage_Richtstab = 55;
const int Condition_Richtstab = 40;
const int Range_Richtstab = 110;
const int Value_Richtstab = 500;
const int Damage_ShortSword5 = 50;
const int Condition_ShortSword5 = 25;
const int Range_ShortSword5 = 50;
const int Value_ShortSword5 = 350;
const int Damage_Hellebarde = 75;
const int Condition_Hellebarde = 60;
const int Range_Hellebarde = 90;
const int Value_Hellebarde = 700;
const int Damage_Schiffsaxt = 55;
const int Condition_Schiffsaxt = 55;
...
const int Damage_AltMachete = 50;
const int Condition_AltMachete = 45;
const int Range_AltMachete = 70;
const int Value_AltMachete = 600;
const int Damage_Zweihaender2 = 110;
const int Condition_Zweihaender2 = 100;
const int Range_Zweihaender2 = 100;
const int Value_Zweihaender2 = 1100;
const int Damage_Hacker = 115;
const int Condition_Hacker = 105;
const int Range_Hacker = 105;
const int Value_Hacker = 1150;
const int Damage_AltHacker = 70;
const int Condition_AltHacker = 65;
const int Range_AltHacker = 95;
const int Value_AltHacker = 700;
const int Damage_Runenschwert = 110;
const int Condition_Runenschwert = 105;
const int Range_Runenschwert = 90;
const int Value_Runenschwert = 1100;
const int Damage_Schwert5 = 115;
const int Condition_Schwert5 = 115;
const int Range_Schwert5 = 100;
const int Value_Schwert5 = 1100;
const int Damage_Streitaxt2 = 125;
const int Condition_Streitaxt2 = 110;
const int Range_Streitaxt2 = 100;
const int Value_Streitaxt2 = 1200;
const int Damage_Zweihaender3 = 130;
const int Condition_Zweihaender3 = 120;
...
const int Damage_Folteraxt = 130;
const int Condition_Folteraxt = 125;
const int Range_Folteraxt = 85;
const int Value_Folteraxt = 1250;
const int Damage_Orkschlaechter = 140;
const int Condition_Orkschlaechter = 140;
...
const int Value_Zweihaender4 = 1400;
const int Damage_Schlachtaxt = 135;
const int Condition_Schlachtaxt = 125;
const int Range_Schlachtaxt = 100;
const int Value_Schlachtaxt = 1350;
const int Damage_Scimitar = 155;
const int Condition_Scimitar = 145;
const int Range_Scimitar = 120;
const int Value_Scimitar = 1550;
const int Damage_Berserkeraxt = 165;
const int Condition_Berserkeraxt = 155;
const int Range_Berserkeraxt = 90;
const int Value_Berserkeraxt = 1700;
const int Damage_Sturmbringer = 175;
const int Condition_Sturmbringer = 165;
const int Range_Sturmbringer = 130;
const int Value_Sturmbringer = 1800;
const int Damage_Drachenschneide = 190;
const int Condition_Drachenschneide = 180;
const int Range_Drachenschneide = 130;
const int Value_Drachenschneide = 2900;
const int Damage_Barbarenstreitaxt = 210;
const int Condition_Barbarenstreitaxt = 200;
const int Range_Barbarenstreitaxt = 95;
const int Value_Barbarenstreitaxt = 3000;

const int Damage_Special_1H_1 = 60;
const int Condition_Special_1H_1 = 45;
const int Range_Special_1H_1 = 90;
const int Value_Special_1H_1 = 750;
const int Damage_Special_2H_1 = 85;
const int Condition_Special_2H_1 = 65;
const int Range_Special_2H_1 = 100;
const int Value_Special_2H_1 = 900;
const int Damage_Special_1H_2 = 100;
const int Condition_Special_1H_2 = 85;
const int Range_Special_1H_2 = 90;
const int Value_Special_1H_2 = 1200;
const int Damage_Special_2H_2 = 125;
const int Condition_Special_2H_2 = 105;
const int Range_Special_2H_2 = 110;
const int Value_Special_2H_2 = 1500;
const int Damage_Special_1H_3 = 140;
const int Condition_Special_1H_3 = 130;
const int Range_Special_1H_3 = 100;
const int Value_Special_1H_3 = 1500;
const int Damage_Special_2H_3 = 165;
const int Condition_Special_2H_3 = 150;
const int Range_Special_2H_3 = 130;
const int Value_Special_2H_3 = 1800;
const int Damage_Special_1H_4 = 160;
const int Condition_Special_1H_4 = 145;
...
const int Condition_Kriegskeule = 45;
const int Range_Kriegskeule = 50;
const int Value_Kriegskeule = 500;
const int Damage_Windknecht = 55;
const int Condition_Windknecht = 60;
const int Range_Windknecht = 55;
const int Value_Windknecht = 450;
const int Damage_Kriegshammer1 = 55;
const int Condition_Kriegshammer1 = 55;
const int Range_Kriegshammer1 = 45;
const int Value_Kriegshammer1 = 550;
const int Damage_Nagelkeule2 = 65;
const int Condition_Nagelkeule2 = 60;
const int Range_Nagelkeule2 = 60;
const int Value_Nagelkeule2 = 600;
const int Damage_RangerStaff = 75;
const int Condition_RangerStaff = 65;
const int Range_RangerStaff = 130;
const int Value_RangerStaff = 850;
const int Damage_Stabkeule = 105;
const int Condition_Stabkeule = 95;
const int Range_Stabkeule = 130;
const int Value_Stabkeule = 1000;
const int Damage_Spicker = 80;
const int Condition_Spicker = 75;
const int Range_Spicker = 60;
const int Value_Spicker = 750;
const int Damage_Steinbrecher = 90;
const int Condition_Steinbrecher = 85;
const int Range_Steinbrecher = 65;
const int Value_Steinbrecher = 850;
const int Damage_Morgenstern = 100;
const int Condition_Morgenstern = 100;
const int Range_Morgenstern = 65;
const int Value_Morgenstern = 900;
const int Damage_Stinger = 110;
const int Condition_Stinger = 110;
const int Range_Stinger = 65;
const int Value_Stinger = 1000;
const int Damage_Streitkolben = 120;
const int Condition_Streitkolben = 115;
const int Range_Streitkolben = 65;
const int Value_Streitkolben = 1100;
const int Damage_Kriegshammer2 = 125;
const int Condition_Kriegshammer2 = 125;
const int Range_Kriegshammer2 = 60;
const int Value_Kriegshammer2 = 1200;
const int Damage_Rabenschnabel = 135;
const int Condition_Rabenschnabel = 135;
const int Range_Rabenschnabel = 65;
const int Value_Rabenschnabel = 1500;
const int Damage_Inquisitor = 150;
const int Condition_Inquisitor = 150;
const int Range_Inquisitor = 70;
const int Value_Inquisitor = 1800;
const int Damage_Sturmknecht = 185;
const int Condition_Sturmknecht = 180;
const int Range_Sturmknecht = 130;
const int Value_Sturmknecht = 1400;
...
const int Condition_Stab01 = 40;
const int Range_Stab01 = 120;
const int Value_Stab01 = 750;
const int Damage_Stab02 = 60;
const int Condition_Stab02 = 40;
const int Range_Stab02 = 110;
const int Value_Stab02 = 900;
const int Damage_Stab03 = 60;
const int Condition_Stab03 = 50;
const int Range_Stab03 = 120;
const int Value_Stab03 = 750;
const int Damage_Stab04 = 85;
const int Condition_Stab04 = 75;
const int Range_Stab04 = 130;
const int Value_Stab04 = 950;
const int Damage_Stab05 = 130;
const int Condition_Stab05 = 120;
const int Range_Stab05 = 130;
const int Value_Stab05 = 1500;
...
const int Condition_VLKSchwert = 30;
const int Range_VLKSchwert = 70;
const int Value_VLKSchwert = 250;
const int Value_BanditTrader = 150;
const int Damage_Foil = 65;
const int Condition_Foil = 50;
const int Range_Foil = 70;
const int Value_Foil = 1200;
const int Damage_Rapier = 90;
const int Condition_Rapier = 75;
const int Range_Rapier = 70;
const int Value_Rapier = 2000;
const int Damage_Meisterdegen = 120;
const int Condition_Meisterdegen = 100;
