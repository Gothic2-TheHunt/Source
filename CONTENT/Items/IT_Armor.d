...
const int VALUE_ITAR_Judge = 250;
const int VALUE_ITAR_Smith = 150;
const int VALUE_ITAR_Barkeeper = 150;
...
const int VALUE_ITAR_KDW_H = 2000;
...
instance ITAR_Xardas(C_Item)
{
	...
	visual_skin = 0;
	material = MAT_LEATHER;
	on_equip = Equip_ITAR_KDT;
	on_unequip = UnEquip_ITAR_KDT;
	description = name;
	text[0] = NAME_Prot_Edge;
	count[0] = protection[PROT_EDGE];
	text[1] = NAME_Prot_Blunt;
...
instance ITAR_KDW_H(C_Item)
{
	...
	visual_skin = 0;
	material = MAT_LEATHER;
	on_equip = Equip_ITAR_KDW;
	on_unequip = UnEquip_ITAR_KDW;
	description = name;
	text[0] = NAME_Prot_Edge;
	count[0] = protection[PROT_EDGE];
	text[1] = NAME_Prot_Blunt;
