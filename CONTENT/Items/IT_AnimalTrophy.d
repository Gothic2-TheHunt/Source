...
const int Value_BugMandibles = 30;
const int Value_Claw = 20;
const int Value_LurkerClaw = 40;
const int Value_Teeth = 20;
const int Value_CrawlerMandibles = 40;
const int Value_Wing = 25;
const int Value_Sting = 30;
const int Value_ReptileSkin = 35;
const int Value_WargFur = 30;
const int Value_DrgSnapperHorn = 120;
const int Value_CrawlerPlate = 50;
const int Value_ShadowFur = 100;
const int Value_SharkSkin = 200;
const int Value_TrollFur = 200;
...
const int Value_TrollBlackFur = 400;
const int Value_GoblinBone = 20;
const int Value_SkeletonBone = 25;
