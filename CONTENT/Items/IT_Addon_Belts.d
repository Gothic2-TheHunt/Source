...
const int Value_ItBE_Addon_Leather_01 = 350;
const int Value_ItBE_Addon_Leather_02 = 350;
const int Value_ItBE_Addon_SLD_01 = 500;
const int Value_ItBE_Addon_NOV_01 = 250;
const int Value_ItBE_Addon_MIL_01 = 500;
...
const int Value_ItBE_Addon_Prot_Edge = 1000;
const int Value_ItBE_Addon_Prot_Point = 500;
const int Value_ItBE_Addon_Prot_Magic = 650;
const int Value_ItBE_Addon_Prot_Fire = 750;
const int Value_ItBE_Addon_Prot_EdgPoi = 1500;
const int Value_ItBE_Addon_Prot_Total = 1800;
const int Value_ItBE_Addon_Prot_Total02 = 2500;
...
const int BeltBonus_ProtTotal2 = 10;
...
instance ItBe_Addon_Prot_TOTAL_02(C_Item)
{
	name = NAME_Addon_Belt;
	mainflag = ITEM_KAT_MAGIC;
	flags = ITEM_BELT | ITEM_MULTI;
	value = Value_ItBE_Addon_Prot_Total02;
	visual = "ItMi_Belt_02.3ds";
	visual_skin = 0;
	material = MAT_METAL;
	on_equip = Equip_ItBe_Addon_Prot_TOTAL_02;
	on_unequip = UnEquip_ItBe_Addon_Prot_TOTAL_02;
	description = "Heroic belt";
	text[1] = NAME_Prot_Weapon;
	count[1] = BeltBonus_ProtTotal2;
	text[2] = NAME_Prot_Point;
	count[2] = BeltBonus_ProtTotal2;
	text[3] = NAME_Prot_Magic;
	count[3] = BeltBonus_ProtTotal2;
	text[4] = NAME_Prot_Fire;
	count[4] = BeltBonus_ProtTotal2;
	text[5] = NAME_Value;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_AMULETTE_STANDARD;
	inv_rotx = INVCAM_ENTF_MISC2_STANDARD;
...
func void Equip_ItBe_Addon_Prot_TOTAL_02()
{
	self.protection[PROT_EDGE] += BeltBonus_ProtTotal2;
	self.protection[PROT_BLUNT] += BeltBonus_ProtTotal2;
	self.protection[PROT_POINT] += BeltBonus_ProtTotal2;
	self.protection[PROT_MAGIC] += BeltBonus_ProtTotal2;
	self.protection[PROT_FIRE] += BeltBonus_ProtTotal2;
};

func void UnEquip_ItBe_Addon_Prot_TOTAL_02()
{
	self.protection[PROT_EDGE] -= BeltBonus_ProtTotal2;
	self.protection[PROT_BLUNT] -= BeltBonus_ProtTotal2;
	self.protection[PROT_POINT] -= BeltBonus_ProtTotal2;
