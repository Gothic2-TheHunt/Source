...
const int Ri_ProtFire03 = 10;
const int Value_Ri_ProtEdge = 250;
const int Ri_ProtEdge = 3;
const int Value_Ri_ProtEdge02 = 500;
const int Ri_ProtEdge02 = 5;
const int Value_Ri_ProtEdge03 = 1000;
const int Ri_ProtEdge03 = 10;
const int Value_Ri_ProtMage = 250;
const int Ri_ProtMage = 3;
const int Value_Ri_ProtMage02 = 500;
const int Ri_ProtMage02 = 5;
const int Value_Ri_ProtMage03 = 1000;
const int Ri_ProtMage03 = 10;
const int Value_Ri_ProtPoint = 250;
const int Ri_ProtPoint = 3;
const int Value_Ri_ProtPoint02 = 500;
const int Ri_ProtPoint02 = 5;
const int Value_Ri_ProtPoint03 = 1000;
const int Ri_ProtPoint03 = 10;
const int Value_Ri_ProtTotal = 1300;
const int Ri_TProtFire = 3;
const int Ri_TProtEdge = 5;
const int Ri_TProtMage = 3;
const int Ri_TProtPoint = 5;
const int Value_Ri_ProtTotal02 = 1800;
const int Ri_TProtFire02 = 5;
const int Ri_TProtEdge02 = 8;
const int Ri_TProtMage02 = 5;
const int Ri_TProtPoint02 = 8;
const int Value_Ri_ProtTotal03 = 2300;
const int Ri_TProtFire03 = 8;
const int Ri_TProtEdge03 = 10;
const int Ri_TProtMage03 = 8;
const int Ri_TProtPoint03 = 10;
...
const int Value_Ri_Mana02 = 900;
const int Ri_Mana02 = 20;
const int Value_Ri_Strg = 300;
const int Ri_Strg = 3;
const int Value_Ri_Strg02 = 500;
const int Ri_Strg02 = 5;
const int Value_Ri_Hp = 450;
const int Ri_Hp = 20;
const int Value_Ri_Hp02 = 700;
const int Ri_Hp02 = 30;
const int Value_Ri_HpMana = 1200;
const int Ri_HpMana_Hp = 25;
const int Ri_HpMana_Mana = 15;
...
instance ItRi_Prot_Fire_01(C_Item)
{
	...
	description = "Ring of Blaze protection";
...
instance ItRi_Prot_Point_03(C_Item)
{
	name = NAME_Ring;
	mainflag = ITEM_KAT_MAGIC;
	flags = ITEM_RING;
	value = Value_Ri_ProtPoint03;
	visual = "ItRi_Prot_Point_02.3ds";
	visual_skin = 0;
	material = MAT_METAL;
	on_equip = Equip_ItRi_Prot_Point_03;
	on_unequip = UnEquip_ItRi_Prot_Point_03;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_ITEMGLIMMER";
	description = "Ring of Marble Skin";
	text[2] = NAME_Prot_Point;
	count[2] = Ri_ProtPoint03;
	text[5] = NAME_Value;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_RING_STANDARD;
	inv_rotz = INVCAM_Z_RING_STANDARD;
...
func void Equip_ItRi_Prot_Point_03()
{
	self.protection[PROT_POINT] += Ri_ProtPoint03;
};

func void UnEquip_ItRi_Prot_Point_03()
{
	self.protection[PROT_POINT] -= Ri_ProtPoint03;
};
...
instance ItRi_Prot_Edge_02(C_Item)
{
	...
	wear = WEAR_EFFECT;
	effect = "SPELLFX_ITEMGLIMMER";
	description = "Ring of Steel Skin";
	text[2] = NAME_Prot_Weapon;
...
instance ItRi_Prot_Edge_03(C_Item)
{
	name = NAME_Ring;
	mainflag = ITEM_KAT_MAGIC;
	flags = ITEM_RING;
	value = Value_Ri_ProtEdge03;
	visual = "ItRi_Prot_Edge_02.3ds";
	visual_skin = 0;
	material = MAT_METAL;
	on_equip = Equip_ItRi_Prot_Edge_03;
	on_unequip = UnEquip_ItRi_Prot_Edge_03;
	wear = WEAR_EFFECT;
	effect = "SPELLFX_ITEMGLIMMER";
	description = "Ring of Ore Skin";
	text[2] = NAME_Prot_Weapon;
	count[2] = Ri_ProtEdge03;
	text[5] = NAME_Value;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_RING_STANDARD;
	inv_rotz = INVCAM_Z_RING_STANDARD;
...
func void Equip_ItRi_Prot_Edge_03()
{
	self.protection[PROT_EDGE] += Ri_ProtEdge03;
	self.protection[PROT_BLUNT] += Ri_ProtEdge03;
};

func void UnEquip_ItRi_Prot_Edge_03()
{
	self.protection[PROT_EDGE] -= Ri_ProtEdge03;
	self.protection[PROT_BLUNT] -= Ri_ProtEdge03;
};
...
instance ItRi_Prot_Mage_03(C_Item)
{
	...
	wear = WEAR_EFFECT;
	effect = "SPELLFX_ITEMGLIMMER";
	description = "Ring of Soul";
	text[2] = NAME_Prot_Magic;
	count[2] = Ri_ProtMage03;
	text[5] = NAME_Value;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_RING_STANDARD;
	inv_rotz = INVCAM_Z_RING_STANDARD;
...
{
	self.protection[PROT_MAGIC] += Ri_ProtMage03;
};
...
instance ItRi_Prot_Total_03(C_Item)
{
	...
	wear = WEAR_EFFECT;
	effect = "SPELLFX_ITEMGLIMMER";
	description = "Ring of Invulnerability";
	text[1] = NAME_Prot_Magic;
	count[1] = Ri_TProtMage03;
	text[2] = NAME_Prot_Fire;
	count[2] = Ri_TProtFire03;
	text[3] = NAME_Prot_Point;
	count[3] = Ri_TProtPoint03;
	text[4] = NAME_Prot_Weapon;
	count[4] = Ri_TProtEdge03;
	text[5] = NAME_Value;
	count[5] = value;
	inv_zbias = INVCAM_ENTF_RING_STANDARD;
	inv_rotz = INVCAM_Z_RING_STANDARD;
...
{
	self.protection[PROT_EDGE] += Ri_TProtEdge03;
	self.protection[PROT_BLUNT] += Ri_TProtEdge03;
	self.protection[PROT_POINT] += Ri_TProtPoint03;
	self.protection[PROT_FIRE] += Ri_TProtFire03;
	self.protection[PROT_MAGIC] += Ri_TProtMage03;
};
