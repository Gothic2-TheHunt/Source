...
instance ItMW_Addon_Keule_1h_01(C_Item)
{
	...
	on_equip = UnEquip_1H_05;
	on_unequip = Equip_1H_05;
	cond_atr[2] = ATR_STRENGTH;
...
instance ItMW_Addon_Keule_2h_01(C_Item)
{
	...
	on_equip = UnEquip_2H_05;
	on_unequip = Equip_2H_05;
	cond_atr[2] = ATR_STRENGTH;
...
instance ItMw_Fencefoil_01(C_Item)
{
	name = "Fencing Sabre";
	mainflag = ITEM_KAT_NF;
	flags = ITEM_SWD;
	material = MAT_METAL;
	value = VALUE_Foil;
	damageTotal = DAMAGE_Foil;
	damagetype = DAM_EDGE;
	range = RANGE_Foil;
	on_equip = Equip_1H_03;
	on_unequip = UnEquip_1H_03;
	cond_atr[2] = ATR_DEXTERITY;
	cond_value[2] = CONDITION_Foil;
