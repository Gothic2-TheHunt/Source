...
instance DIA_GornNW_PICKPOCKET(C_Info)
{
	npc = PC_Fighter_NW_vor_DJG;
	nr = 900;
	condition = DIA_GornNW_PICKPOCKET_Condition;
	information = DIA_GornNW_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_20;
};


func int DIA_GornNW_PICKPOCKET_Condition()
{
	return C_Beklauen(12,30);
};

func void DIA_GornNW_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_GornNW_PICKPOCKET);
	Info_AddChoice(DIA_GornNW_PICKPOCKET,Dialog_Back,DIA_GornNW_PICKPOCKET_BACK);
	Info_AddChoice(DIA_GornNW_PICKPOCKET,DIALOG_PICKPOCKET,DIA_GornNW_PICKPOCKET_DoIt);
};

func void DIA_GornNW_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_GornNW_PICKPOCKET);
};

func void DIA_GornNW_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_GornNW_PICKPOCKET);
};
