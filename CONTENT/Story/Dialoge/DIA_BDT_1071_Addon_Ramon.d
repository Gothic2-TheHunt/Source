...
instance DIA_Addon_Ramon_PICKPOCKET(C_Info)
{
	npc = BDT_1071_Addon_Ramon;
	nr = 900;
	condition = DIA_Addon_Ramon_PICKPOCKET_Condition;
	information = DIA_Addon_Ramon_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_40;
};


func int DIA_Addon_Ramon_PICKPOCKET_Condition()
{
	return C_Beklauen(33,30);
};

func void DIA_Addon_Ramon_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Ramon_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Ramon_PICKPOCKET,Dialog_Back,DIA_Addon_Ramon_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Ramon_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Ramon_PICKPOCKET_DoIt);
};

func void DIA_Addon_Ramon_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Ramon_PICKPOCKET);
};

func void DIA_Addon_Ramon_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Addon_Ramon_PICKPOCKET);
};
