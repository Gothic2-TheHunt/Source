...
instance DIA_Addon_Patrick_PICKPOCKET(C_Info)
{
	npc = STRF_1118_Addon_Patrick;
	nr = 900;
	condition = DIA_Addon_Patrick_PICKPOCKET_Condition;
	information = DIA_Addon_Patrick_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_40;
};


func int DIA_Addon_Patrick_PICKPOCKET_Condition()
{
	return C_Beklauen(23,19);
};

func void DIA_Addon_Patrick_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Patrick_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Patrick_PICKPOCKET,Dialog_Back,DIA_Addon_Patrick_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Patrick_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Patrick_PICKPOCKET_DoIt);
};

func void DIA_Addon_Patrick_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Patrick_PICKPOCKET);
};

func void DIA_Addon_Patrick_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Addon_Patrick_PICKPOCKET);
};