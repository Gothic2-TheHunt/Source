...
instance DIA_Addon_Cronos_NW_PICKPOCKET(C_Info)
{
	npc = KDW_1401_Addon_Cronos_NW;
	nr = 900;
	condition = DIA_Addon_Cronos_NW_PICKPOCKET_Condition;
	information = DIA_Addon_Cronos_NW_PICKPOCKET_Info;
	permanent = TRUE;
	description = "(It would be risky to steal his scroll)";
};

func int DIA_Addon_Cronos_NW_PICKPOCKET_Condition()
{
	if((Npc_GetTalentSkill(other,NPC_TALENT_PICKPOCKET) == 1) && (self.aivar[AIV_PlayerHasPickedMyPocket] == FALSE) && (other.attribute[ATR_DEXTERITY] >= (46 - Theftdiff)))
	{
		return TRUE;
	};
};

func void DIA_Addon_Cronos_NW_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Cronos_NW_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Cronos_NW_PICKPOCKET,Dialog_Back,DIA_Addon_Cronos_NW_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Cronos_NW_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Cronos_NW_PICKPOCKET_DoIt);
};

func void DIA_Addon_Cronos_NW_PICKPOCKET_DoIt()
{
	if(other.attribute[ATR_DEXTERITY] >= 46)
	{
...
func void DIA_Addon_Cronos_NW_PICKPOCKET_BACK()
{
