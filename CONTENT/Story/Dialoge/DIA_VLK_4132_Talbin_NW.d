...
instance DIA_Talbin_NW_PICKPOCKET(C_Info)
{
	npc = VLK_4132_Talbin_NW;
	nr = 900;
	condition = DIA_Talbin_NW_PICKPOCKET_Condition;
	information = DIA_Talbin_NW_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_80;
};


func int DIA_Talbin_NW_PICKPOCKET_Condition()
{
	return C_Beklauen(73,75);
};

func void DIA_Talbin_NW_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Talbin_NW_PICKPOCKET);
	Info_AddChoice(DIA_Talbin_NW_PICKPOCKET,Dialog_Back,DIA_Talbin_NW_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Talbin_NW_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Talbin_NW_PICKPOCKET_DoIt);
};

func void DIA_Talbin_NW_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Talbin_NW_PICKPOCKET);
};

func void DIA_Talbin_NW_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Talbin_NW_PICKPOCKET);
};
