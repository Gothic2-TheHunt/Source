...
func void DIA_Thekla_PERM_Info()
{
	...
	if (Thekla_GaveStewGuild == FALSE && (other.guild != GIL_NONE && other.guild != GIL_MIL))
	{
...
instance DIA_Thekla_PICKPOCKET(C_Info)
{
	...
	permanent = TRUE;
	description = "(It would be risky to steal her stew)";
};


func int DIA_Thekla_PICKPOCKET_Condition()
{
	if((Npc_GetTalentSkill(other,NPC_TALENT_PICKPOCKET) == 1) && (self.aivar[AIV_PlayerHasPickedMyPocket] == FALSE) && (other.attribute[ATR_DEXTERITY] >= (56 - Theftdiff)))
	{
		return TRUE;
	};
};
...
{
	if(other.attribute[ATR_DEXTERITY] >= 56)
	{
