...
instance DIA_Onar_PICKPOCKET(C_Info)
{
	npc = Bau_900_Onar;
	nr = 900;
	condition = DIA_Onar_PICKPOCKET_Condition;
	information = DIA_Onar_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_120;
};


func int DIA_Onar_PICKPOCKET_Condition()
{
	return C_Beklauen(124,500);
};

func void DIA_Onar_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Onar_PICKPOCKET);
	Info_AddChoice(DIA_Onar_PICKPOCKET,Dialog_Back,DIA_Onar_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Onar_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Onar_PICKPOCKET_DoIt);
};

func void DIA_Onar_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Onar_PICKPOCKET);
};

func void DIA_Onar_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Onar_PICKPOCKET);
};
