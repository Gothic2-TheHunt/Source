...
instance DIA_Andre_PICKPOCKET(C_Info)
{
	npc = MIL_311_Andre;
	nr = 900;
	condition = DIA_Andre_PICKPOCKET_Condition;
	information = DIA_Andre_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_100;
};


func int DIA_Andre_PICKPOCKET_Condition()
{
	return C_Beklauen(86,185);
};

func void DIA_Andre_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Andre_PICKPOCKET);
	Info_AddChoice(DIA_Andre_PICKPOCKET,Dialog_Back,DIA_Andre_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Andre_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Andre_PICKPOCKET_DoIt);
};

func void DIA_Andre_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Andre_PICKPOCKET);
};

func void DIA_Andre_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Andre_PICKPOCKET);
};
