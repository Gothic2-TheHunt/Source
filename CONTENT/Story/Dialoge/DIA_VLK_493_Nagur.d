...
func void DIA_Nagur_Deal_Info()
{
	...
	if(B_GetDayPlus() > NagurDay)
	{
		...
		if(Npc_IsDead(VLK_476_Fenia) == FALSE)
		{
			CreateInvItems(VLK_476_Fenia,ItFo_Apple,7);
			CreateInvItems(VLK_476_Fenia,ItFo_Cheese,3);
			CreateInvItems(VLK_476_Fenia,ItFo_Bacon,3);
			CreateInvItems(VLK_476_Fenia,ItFo_Sausage,4);

		};
		if(Npc_IsDead(VLK_431_Kardif) == FALSE)
		{
