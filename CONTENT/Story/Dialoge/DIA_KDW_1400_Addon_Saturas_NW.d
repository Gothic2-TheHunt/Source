...
instance DIA_Addon_Saturas_PICKPOCKET(C_Info)
{
	npc = KDW_1400_Addon_Saturas_NW;
	nr = 900;
	condition = DIA_Addon_Saturas_PICKPOCKET_Condition;
	information = DIA_Addon_Saturas_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_60;
};


func int DIA_Addon_Saturas_PICKPOCKET_Condition()
{
	return C_Beklauen(56,85);
};

func void DIA_Addon_Saturas_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Saturas_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Saturas_PICKPOCKET,Dialog_Back,DIA_Addon_Saturas_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Saturas_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Saturas_PICKPOCKET_DoIt);
};

func void DIA_Addon_Saturas_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Saturas_PICKPOCKET);
};

func void DIA_Addon_Saturas_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Addon_Saturas_PICKPOCKET);
};
