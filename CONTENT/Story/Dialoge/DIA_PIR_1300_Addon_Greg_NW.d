...
func void DIA_Addon_Greg_NW_FoundTreasure_ja()
{
	...
	Npc_GetInvItem(other, ItAm_Prot_Point_01);
	if(((item.flags & ITEM_AMULET) == ITEM_AMULET) && (((item.flags & ITEM_ACTIVE) == ITEM_ACTIVE)))
	{
		item.flags = item.flags & (~ITEM_ACTIVE);
		other.protection[PROT_POINT] -= Am_ProtPoint;
	};	
