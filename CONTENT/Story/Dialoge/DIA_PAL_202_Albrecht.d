...
func void DIA_Albrecht_TEACHPalRunes_Heal()
{
	...
	if(PLAYER_TALENT_RUNES[SPL_PalLightHeal] == FALSE)
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,B_BuildLearnString("Heal Light Wounds",B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalLightHeal)),DIA_Albrecht_TEACHPalRunes_PalLightHeal);
	}
	else if((PLAYER_TALENT_RUNES[SPL_PalMediumHeal] == FALSE) && (PLAYER_TALENT_RUNES[SPL_PalLightHeal] == TRUE) && (MIS_ReadyforChapter4 == TRUE))
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,B_BuildLearnString("Heal Medium Wounds",B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalMediumHeal)),DIA_Albrecht_TEACHPalRunes_PalMediumHeal);
	}
	else if((PLAYER_TALENT_RUNES[SPL_PalFullHeal] == FALSE) && (PLAYER_TALENT_RUNES[SPL_PalMediumHeal] == TRUE) && (Kapitel >= 4))
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,B_BuildLearnString("Heal Heavy Wounds",B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalFullHeal)),DIA_Albrecht_TEACHPalRunes_PalFullHeal);
	}
	else
	{
...
func void DIA_Albrecht_TEACHPalRunes_Combat()
{
	...
	if((PLAYER_TALENT_RUNES[SPL_PalHolyBolt] == FALSE))
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,B_BuildLearnString("Holy Arrow",B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalHolyBolt)),DIA_Albrecht_TEACHPalRunes_PalHolyBolt);
	}
	else if((PLAYER_TALENT_RUNES[SPL_PalRepelEvil] == FALSE) && (PLAYER_TALENT_RUNES[SPL_PalHolyBolt] == TRUE) && (MIS_ReadyforChapter4 == TRUE))
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,B_BuildLearnString("Expel evil",B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalRepelEvil)),DIA_Albrecht_TEACHPalRunes_PalRepelEvil);
	}
	else if((PLAYER_TALENT_RUNES[SPL_PalDestroyEvil] == FALSE) && (PLAYER_TALENT_RUNES[SPL_PalRepelEvil] == TRUE) && (PAL_KnowsAbout_FINAL_BLESSING == TRUE))
	{
		Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,Dialog_Back,DIA_Albrecht_TEACHPalRunes_BACK);
		Info_AddChoice(DIA_Albrecht_TEACHPalRunes,B_BuildLearnString("Destroy evil",B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalDestroyEvil)),DIA_Albrecht_TEACHPalRunes_PalDestroyEvil);
	}
	else
	{
		B_Albrecht_YouAreNotWorthy();
...
{
	if(other.lp < B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalLightHeal))
	{
	...
	other.lp = other.lp - B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalLightHeal);
	Info_ClearChoices(DIA_Albrecht_TEACHPalRunes);
	return TRUE;
};
...
{
	if(other.lp < B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalMediumHeal))
	{
		PrintScreen(PRINT_NotEnoughLearnPoints,-1,-1,FONT_ScreenSmall,2);
		B_Say(self,other,"$NOLEARNNOPOINTS");
		return FALSE;
	...
	other.lp = other.lp - B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalMediumHeal);
	return TRUE;
};

func int DIA_Albrecht_TEACHPalRunes_PalFullHeal()
{
	if(other.lp < B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalFullHeal))
	{
		PrintScreen(PRINT_NotEnoughLearnPoints,-1,-1,FONT_ScreenSmall,2);
		B_Say(self,other,"$NOLEARNNOPOINTS");
		return FALSE;
	...
	other.lp = other.lp - B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalFullHeal);
	return TRUE;
};

func int DIA_Albrecht_TEACHPalRunes_PalHolyBolt()
{
	if(other.lp < B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalHolyBolt))
	{
		PrintScreen(PRINT_NotEnoughLearnPoints,-1,-1,FONT_ScreenSmall,2);
		B_Say(self,other,"$NOLEARNNOPOINTS");
		return FALSE;
	...
	other.lp = other.lp - B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalHolyBolt);
	return TRUE;
};

func int DIA_Albrecht_TEACHPalRunes_PalRepelEvil()
{
	if(other.lp < B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalRepelEvil))
	{
		PrintScreen(PRINT_NotEnoughLearnPoints,-1,-1,FONT_ScreenSmall,2);
		B_Say(self,other,"$NOLEARNNOPOINTS");
		return FALSE;
	...
	other.lp = other.lp - B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalRepelEvil);
	return TRUE;
};

func int DIA_Albrecht_TEACHPalRunes_PalDestroyEvil()
{
	if(other.lp < B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalDestroyEvil))
	{
		PrintScreen(PRINT_NotEnoughLearnPoints,-1,-1,FONT_ScreenSmall,2);
		B_Say(self,other,"$NOLEARNNOPOINTS");
		return FALSE;
	...
	other.lp = other.lp - B_GetLearnCostTalent(other,NPC_TALENT_RUNES,SPL_PalDestroyEvil);
	return TRUE;
};
