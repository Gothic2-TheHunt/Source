...
instance DIA_Addon_Myxir_CITY_PICKPOCKET(C_Info)
{
	npc = KDW_14030_Addon_Myxir_ADW;
	nr = 900;
	condition = DIA_Addon_Myxir_CITY_PICKPOCKET_Condition;
	information = DIA_Addon_Myxir_CITY_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_80;
};

func int DIA_Addon_Myxir_CITY_PICKPOCKET_Condition()
{
	return C_Beklauen(79,95);
};

func void DIA_Addon_Myxir_CITY_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Myxir_CITY_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Myxir_CITY_PICKPOCKET,Dialog_Back,DIA_Addon_Myxir_CITY_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Myxir_CITY_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Myxir_CITY_PICKPOCKET_DoIt);
};

func void DIA_Addon_Myxir_CITY_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Myxir_CITY_PICKPOCKET);
};

func void DIA_Addon_Myxir_CITY_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Addon_Myxir_CITY_PICKPOCKET);
};