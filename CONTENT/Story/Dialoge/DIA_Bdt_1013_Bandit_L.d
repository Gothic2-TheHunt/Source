...
instance DIA_BDT_1013_BANDIT_Kap3_Bonus(C_Info)
{
	npc = Bdt_1013_Bandit_L;
	nr = 5;
	condition = DIA_BDT_1013_BANDIT_Kap3_Bonus_Condition;
	information = DIA_BDT_1013_BANDIT_Kap3_Bonus_Info;
	permanent = FALSE;
	important = TRUE;
};


func int DIA_BDT_1013_BANDIT_Kap3_Bonus_Condition()
{
...
func void DIA_BDT_1013_BANDIT_Kap3_Bonus_Info()
{
	...
	B_GivePlayerXP(XP_Jesse_Alive);
};




instance DIA_1013_BANDIT_PICKPOCKET(C_Info)
{
	npc = Bdt_1013_Bandit_L;
	nr = 900;
	condition = DIA_1013_BANDIT_PICKPOCKET_Condition;
	information = DIA_1013_BANDIT_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_20;
};


func int DIA_1013_BANDIT_PICKPOCKET_Condition()
{
	return C_Beklauen(13,15);
};

func void DIA_1013_BANDIT_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_1013_BANDIT_PICKPOCKET);
	Info_AddChoice(DIA_1013_BANDIT_PICKPOCKET,Dialog_Back,DIA_1013_BANDIT_PICKPOCKET_BACK);
	Info_AddChoice(DIA_1013_BANDIT_PICKPOCKET,DIALOG_PICKPOCKET,DIA_1013_BANDIT_PICKPOCKET_DoIt);
};

func void DIA_1013_BANDIT_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_1013_BANDIT_PICKPOCKET);
};

func void DIA_1013_BANDIT_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_1013_BANDIT_PICKPOCKET);
};