...
func void DIA_Constantino_Trade_Info()
{
	...
	{
		FlaskAmount = Kapitel * 5;
		CreateInvItems(self,ItMi_Flask,FlaskAmount);
	};
...
var int Constantino_Zustimmung_Once;
func void DIA_Constantino_ZUSTIMMUNG_Info()
{
	...
	if(B_GetGreatestPetzCrime(self) == CRIME_NONE)
	{
		...
		if(Constantino_Zustimmung_Once == FALSE)
		{
			B_GivePlayerXP(XP_Zustimmung);
			Constantino_Zustimmung_Once = TRUE;
		};
	}
	else
	{
...
func void DIA_Constantino_TEACH_Info()
{
	...
	if(PLAYER_TALENT_ALCHEMY[POTION_Perm_STR] == FALSE && (Kapitel >= 3))
	{
