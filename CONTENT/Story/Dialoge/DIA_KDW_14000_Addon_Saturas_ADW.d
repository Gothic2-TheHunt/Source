...
func void DIA_Addon_Saturas_RavenInfos_Info()
{
	...
	if(RavenNeuigkeit != 0)
	{
		XP_RavenNeuigkeit = RavenNeuigkeit * XP_AmbientKap2;
...
func void DIA_Addon_Saturas_ADW_CIRCLE_Info()
{
	...
	else if((Npc_GetTalentSkill(hero,NPC_TALENT_MAGE) == 3) && (Kapitel >= 3))
	{
	...
	else if((Npc_GetTalentSkill(hero,NPC_TALENT_MAGE) == 4) && (Kapitel >= 3))
	{
