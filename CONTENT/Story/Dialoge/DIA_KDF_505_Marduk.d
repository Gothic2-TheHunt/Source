...
{
	if((MIS_KlosterArbeit == LOG_Running) || (other.guild != GIL_KDF && other.guild != GIL_NOV))
	{
		return TRUE;
	};
};
...
func void DIA_Marduk_Arbeit_Info()
{
	...
	{
		B_LogEntry(Topic_MardukBeten,"The magician Marduk asked me to say a prayer for the paladins.");
	};
