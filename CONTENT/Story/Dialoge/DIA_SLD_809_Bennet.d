...
func void DIA_Bennet_TeachSmith_Info()
{
	...
	else if((Kapitel >= 3) && (MIS_RescueBennet == LOG_SUCCESS) && (Bennet_Kap4Smith == FALSE))
	{
	...
	if((PLAYER_TALENT_SMITH[WEAPON_1H_Special_02] == FALSE) && (Kapitel >= 2) && (PLAYER_TALENT_SMITH[WEAPON_1H_Special_01] == TRUE))
	{
	...
	if((PLAYER_TALENT_SMITH[WEAPON_2H_Special_02] == FALSE) && (Kapitel >= 2) && (PLAYER_TALENT_SMITH[WEAPON_2H_Special_01] == TRUE))
	{
	...
	if((PLAYER_TALENT_SMITH[WEAPON_1H_Special_03] == FALSE) && (Kapitel >= 3) && (PLAYER_TALENT_SMITH[WEAPON_1H_Special_02] == TRUE))
	{
	...
	if((PLAYER_TALENT_SMITH[WEAPON_2H_Special_03] == FALSE) && (Kapitel >= 3) && (PLAYER_TALENT_SMITH[WEAPON_2H_Special_02] == TRUE))
	{
	...
	if((PLAYER_TALENT_SMITH[WEAPON_1H_Special_04] == FALSE) && (MIS_ReadyforChapter4 == TRUE) && (PLAYER_TALENT_SMITH[WEAPON_1H_Special_03] == TRUE))
	{
	...
	if((PLAYER_TALENT_SMITH[WEAPON_2H_Special_04] == FALSE) && (MIS_ReadyforChapter4 == TRUE) && (PLAYER_TALENT_SMITH[WEAPON_2H_Special_03] == TRUE))
	{
...
{
	if(Npc_KnowsInfo(other,DIA_Bennet_ThankYou) && MIS_ReadyforChapter4 == TRUE)
	{
		return TRUE;
	};
};
...
instance DIA_Bennet_DJG_ARMOR_M(C_Info)
{
	...
	permanent = TRUE;
	description = "Medium dragon hunter armor: (12000 gold)";
};
...
instance DIA_Bennet_DJG_ARMOR_H(C_Info)
{
	...
	permanent = TRUE;
	description = "Heavy dragon hunter armor: (20000 gold)";
};
