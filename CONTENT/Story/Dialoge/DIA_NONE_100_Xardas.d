...
func void DIA_Addon_Xardas_Hello_Dragons()
{
	...
	AI_Output(self,other,"DIA_Xardas_Hello_14_11");	//They are creatures of an ancient power. I can sense their presence - even here.
...
func void DIA_Xardas_TODO_Info()
{
	...
	B_LogEntry(TOPIC_INNOSEYE,"A contingent of Paladins is stationed in Khorinis. They have a powerful artifact with them: The Eye of Innos. It's power could help us fend off the Dragons. I need to persuade the Paladins to support us.");
};
...
func void DIA_Addon_Xardas_AddonSuccess_Info()
{
	...
	if(C_ScHasBeliarsWeapon())
	{
		...
		B_GivePlayerXP(XP_AmbientKap2 * 3);
	}
	else
	{
...
instance DIA_Xardas_Robe(C_Info)
{
	npc = NONE_100_Xardas;
	nr = 41;
	condition = DIA_Xardas_Robe_Condition;
	information = DIA_Xardas_Robe_Info;
	description = "Where can I find better equipment?";
};
...
func void DIA_Xardas_Robe_Info()
{
	AI_Output(other,self,"DIA_Xardas_EQUIPMENT_15_00");	//Where can I find better equipment?
	AI_Output(self,other,"DIA_Xardas_WEAPON_14_01");	//I can only give you whatever little I have here.
	AI_Output(self,other,"DIA_Xardas_PYROWILLNICHT_14_13");	//It is of no further use to me. So I guess it can at least fulfill this purpose.
...
instance DIA_Xardas_PICKPOCKET(C_Info)
{
	npc = NONE_100_Xardas;
	nr = 900;
	condition = DIA_Xardas_PICKPOCKET_Condition;
	information = DIA_Xardas_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_120;
};


func int DIA_Xardas_PICKPOCKET_Condition()
{
	return C_Beklauen(103,250);
};

func void DIA_Xardas_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Xardas_PICKPOCKET);
	Info_AddChoice(DIA_Xardas_PICKPOCKET,Dialog_Back,DIA_Xardas_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Xardas_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Xardas_PICKPOCKET_DoIt);
};

func void DIA_Xardas_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Xardas_PICKPOCKET);
};

func void DIA_Xardas_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Xardas_PICKPOCKET);
};
