...
instance DIA_Addon_Riordian_PICKPOCKET(C_Info)
{
	npc = KDW_1404_Addon_Riordian_NW;
	nr = 900;
	condition = DIA_Addon_Riordian_PICKPOCKET_Condition;
	information = DIA_Addon_Riordian_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_40;
};


func int DIA_Addon_Riordian_PICKPOCKET_Condition()
{
	return C_Beklauen(31,45);
};

func void DIA_Addon_Riordian_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Riordian_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Riordian_PICKPOCKET,Dialog_Back,DIA_Addon_Riordian_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Riordian_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Riordian_PICKPOCKET_DoIt);
};

func void DIA_Addon_Riordian_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Riordian_PICKPOCKET);	
};

func void DIA_Addon_Riordian_PICKPOCKET_BACK()
{
