...
instance DIA_Addon_Merdarion_PICKPOCKET(C_Info)
{
	npc = KDW_1405_Addon_Merdarion_NW;
	nr = 900;
	condition = DIA_Addon_Merdarion_PICKPOCKET_Condition;
	information = DIA_Addon_Merdarion_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_60;
};


func int DIA_Addon_Merdarion_PICKPOCKET_Condition()
{
	return C_Beklauen(41,55);
};

func void DIA_Addon_Merdarion_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Merdarion_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Merdarion_PICKPOCKET,Dialog_Back,DIA_Addon_Merdarion_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Merdarion_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Merdarion_PICKPOCKET_DoIt);
};

func void DIA_Addon_Merdarion_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Merdarion_PICKPOCKET);
};

func void DIA_Addon_Merdarion_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Addon_Merdarion_PICKPOCKET);
};
