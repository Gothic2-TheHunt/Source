...
instance DIA_Peck_PICKPOCKET(C_Info)
{
	...
	permanent = TRUE;
	description = "(It would be simple to steal his key)";
};


func int DIA_Peck_PICKPOCKET_Condition()
{
	if((Npc_GetTalentSkill(other,NPC_TALENT_PICKPOCKET) == 1) && (self.aivar[AIV_PlayerHasPickedMyPocket] == FALSE) && (Npc_HasItems(self,ItKe_City_Tower_05) >= 1) && (other.attribute[ATR_DEXTERITY] >= (40 - Theftdiff)))
	{
		return TRUE;
	};
};
...
{
	if(other.attribute[ATR_DEXTERITY] >= 34)
	{
