...
instance DIA_Addon_Samuel_PICKPOCKET(C_Info)
{
	npc = PIR_1351_Addon_Samuel;
	nr = 900;
	condition = DIA_Addon_Samuel_PICKPOCKET_Condition;
	information = DIA_Addon_Samuel_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_60;
};


func int DIA_Addon_Samuel_PICKPOCKET_Condition()
{
	return C_Beklauen(42,55);
};

func void DIA_Addon_Samuel_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Samuel_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Samuel_PICKPOCKET,Dialog_Back,DIA_Addon_Samuel_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Samuel_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Samuel_PICKPOCKET_DoIt);
};

func void DIA_Addon_Samuel_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Samuel_PICKPOCKET);
};

func void DIA_Addon_Samuel_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Addon_Samuel_PICKPOCKET);
};