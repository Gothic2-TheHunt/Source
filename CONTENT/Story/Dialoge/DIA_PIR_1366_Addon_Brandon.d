...
instance DIA_Addon_Brandon_PICKPOCKET(C_Info)
{
	npc = PIR_1366_Addon_Brandon;
	nr = 900;
	condition = DIA_Addon_Brandon_PICKPOCKET_Condition;
	information = DIA_Addon_Brandon_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_60;
};


func int DIA_Addon_Brandon_PICKPOCKET_Condition()
{
	return C_Beklauen(46,67);
};

func void DIA_Addon_Brandon_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Brandon_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Brandon_PICKPOCKET,Dialog_Back,DIA_Addon_Brandon_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Brandon_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Brandon_PICKPOCKET_DoIt);
};

func void DIA_Addon_Brandon_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Brandon_PICKPOCKET);
};

func void DIA_Addon_Brandon_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Addon_Brandon_PICKPOCKET);
};
