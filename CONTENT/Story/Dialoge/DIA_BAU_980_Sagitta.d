...
instance DIA_Sagitta_PICKPOCKET(C_Info)
{
	...
	permanent = TRUE;
	description = "(It would be difficult to steal her potion)";
};


func int DIA_Sagitta_PICKPOCKET_Condition()
{
	if((Npc_GetTalentSkill(other,NPC_TALENT_PICKPOCKET) == 1) && (self.aivar[AIV_PlayerHasPickedMyPocket] == FALSE) && (other.attribute[ATR_DEXTERITY] >= (77 - Theftdiff)))
	{
		return TRUE;
	};
};
...
{
	if(other.attribute[ATR_DEXTERITY] >= 77)
	{
