...
{
	if((Lares_RangerHelp == TRUE) && (other.guild == GIL_NONE) && (Lares_HelpedAllGuilds == FALSE))
	{
		return TRUE;
	};
};
...
func void DIA_Addon_Lares_Gilde_SLD()
{
	...
	if((RangerHelp_gildeMIL == TRUE) && (RangerHelp_gildeKDF == TRUE) && (RangerHelp_gildeSLD == TRUE))
	{
		Lares_HelpedAllGuilds = TRUE;
	};
