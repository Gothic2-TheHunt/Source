...
instance DIA_GornOW_PICKPOCKET(C_Info)
{
	npc = PC_Fighter_OW;
	nr = 900;
	condition = DIA_GornOW_PICKPOCKET_Condition;
	information = DIA_GornOW_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_20;
};


func int DIA_GornOW_PICKPOCKET_Condition()
{
	return C_Beklauen(12,10);
};

func void DIA_GornOW_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_GornOW_PICKPOCKET);
	Info_AddChoice(DIA_GornOW_PICKPOCKET,Dialog_Back,DIA_GornOW_PICKPOCKET_BACK);
	Info_AddChoice(DIA_GornOW_PICKPOCKET,DIALOG_PICKPOCKET,DIA_GornOW_PICKPOCKET_DoIt);
};

func void DIA_GornOW_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_GornOW_PICKPOCKET);
};

func void DIA_GornOW_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_GornOW_PICKPOCKET);
};
