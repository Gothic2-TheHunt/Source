...
func void DIA_Addon_Pardos_trank_02()
{
	...
	Pardos_Geheilt = TRUE;
	B_SayPardosThanks();
	B_GivePlayerXP(XP_AmbientKap2 * 2);
};
...
instance DIA_Addon_Pardos_PICKPOCKET(C_Info)
{
	npc = STRF_1122_Addon_Pardos;
	nr = 900;
	condition = DIA_Addon_Pardos_PICKPOCKET_Condition;
	information = DIA_Addon_Pardos_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_20;
};


func int DIA_Addon_Pardos_PICKPOCKET_Condition()
{
	return C_Beklauen(22,14);
};

func void DIA_Addon_Pardos_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Pardos_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Pardos_PICKPOCKET,Dialog_Back,DIA_Addon_Pardos_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Pardos_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Pardos_PICKPOCKET_DoIt);
};

func void DIA_Addon_Pardos_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Pardos_PICKPOCKET);
};

func void DIA_Addon_Pardos_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Addon_Pardos_PICKPOCKET);
};