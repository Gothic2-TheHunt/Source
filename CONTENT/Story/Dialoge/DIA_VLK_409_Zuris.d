...
instance DIA_Zuris_PICKPOCKET(C_Info)
{
	...
	permanent = TRUE;
	description = "(It would be risky to steal his potion)";
};


func int DIA_Zuris_PICKPOCKET_Condition()
{
	if((Npc_GetTalentSkill(other,NPC_TALENT_PICKPOCKET) == 1) && (self.aivar[AIV_PlayerHasPickedMyPocket] == FALSE) && (other.attribute[ATR_DEXTERITY] >= (70 - Theftdiff)))
	{
		return TRUE;
	};
};
...
func void DIA_Zuris_Minenanteil_Info()
{
	...
	B_GivePlayerXP(XP_Caught_Mining_Share);
};
