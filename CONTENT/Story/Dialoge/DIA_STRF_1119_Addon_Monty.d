...
instance DIA_Addon_Monty_PICKPOCKET(C_Info)
{
	npc = STRF_1119_Addon_Monty;
	nr = 900;
	condition = DIA_Addon_Monty_PICKPOCKET_Condition;
	information = DIA_Addon_Monty_PICKPOCKET_Info;
	permanent = TRUE;
	description = Pickpocket_20;
};


func int DIA_Addon_Monty_PICKPOCKET_Condition()
{
	return C_Beklauen(17,13);
};

func void DIA_Addon_Monty_PICKPOCKET_Info()
{
	Info_ClearChoices(DIA_Addon_Monty_PICKPOCKET);
	Info_AddChoice(DIA_Addon_Monty_PICKPOCKET,Dialog_Back,DIA_Addon_Monty_PICKPOCKET_BACK);
	Info_AddChoice(DIA_Addon_Monty_PICKPOCKET,DIALOG_PICKPOCKET,DIA_Addon_Monty_PICKPOCKET_DoIt);
};

func void DIA_Addon_Monty_PICKPOCKET_DoIt()
{
	B_Beklauen();
	Info_ClearChoices(DIA_Addon_Monty_PICKPOCKET);
};

func void DIA_Addon_Monty_PICKPOCKET_BACK()
{
	Info_ClearChoices(DIA_Addon_Monty_PICKPOCKET);
};
