...
func int B_GetLearnCostTalent(var C_Npc oth,var int talent,var int skill)
{
	...
	if(talent == NPC_TALENT_1H)
	{
		...
		else if(oth.aivar[REAL_TALENT_1H] >= 45)
		{
			kosten = 3;
		}
	...
	if(talent == NPC_TALENT_2H)
	{
		...
		else if(oth.aivar[REAL_TALENT_2H] >= 45)
		{
			kosten = 3;
		}
	...
	{
		if(oth.aivar[REAL_TALENT_BOW] >= 85)
		{
			kosten = 5;
		}
		else if(oth.aivar[REAL_TALENT_BOW] >= 70)
		{
			kosten = 4;
		}
		else if(oth.aivar[REAL_TALENT_BOW] >= 50)
		{
			kosten = 3;
		}
	...
	{
		if(oth.aivar[REAL_TALENT_CROSSBOW] >= 85)
		{
			kosten = 5;
		}
		else if(oth.aivar[REAL_TALENT_CROSSBOW] >= 70)
		{
			kosten = 4;
		}
		else if(oth.aivar[REAL_TALENT_CROSSBOW] >= 50)
		{
			kosten = 3;
		}
