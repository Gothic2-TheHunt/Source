...
const string Topic_Strength = "Bonus Strength";
const string Topic_Dexterity = "Bonus Dexterity";
const string Topic_Health = "Bonus Health";
const string Topic_Mana = "Bonus Mana";
const string Topic_Onehanded = "Bonus One-Handed";
const string Topic_Twohanded = "Bonus Two-Handed";
const string Topic_Bow = "Bonus Bow";
const string Topic_Crossbow = "Bonus Crossbow";
