...
func void player_hotkey_lame_potion()
{
	...
	{
		if(Npc_HasItems(hero,ItPo_Mana_Addon_04) && ((hero.attribute[ATR_MANA_MAX] - hero.attribute[ATR_MANA]) >= Pure_Mana_Min))
		{
			// var int ManaNeeded;
			// ManaNeeded = hero.attribute[ATR_MANA_MAX] - hero.attribute[ATR_MANA];
...
func void player_hotkey_lame_heal()
{
	if(Npc_IsInState(hero,ZS_Dead) == FALSE)
	{
		if(Npc_HasItems(hero,ItPo_Health_Addon_04) && ((hero.attribute[ATR_HITPOINTS_MAX] - hero.attribute[ATR_HITPOINTS]) >= Pure_Health_Min))
		{
			// var int HealthNeeded;
			// HealthNeeded = hero.attribute[ATR_HITPOINTS_MAX] - hero.attribute[ATR_HITPOINTS];
