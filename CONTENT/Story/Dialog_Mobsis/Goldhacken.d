...
func void PC_Goldhacken_Addon_Chance_Info()
{
	...
	{
		concatText = ConcatStrings("A Bloody Beginner (",IntToString(Hero_HackChance));
	}
	...
	{
		concatText = ConcatStrings("An Experienced Gold Digger (",IntToString(Hero_HackChance));
	}
	...
	{
		concatText = ConcatStrings("A damn good Digger ( ",IntToString(Hero_HackChance));
	}
