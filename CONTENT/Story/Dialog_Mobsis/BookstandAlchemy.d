...
func void Use_BookstandALCHEMY1_S1()
{
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(her))
	{
		...
		Doc_PrintLine(nDocID,1,"");
		Doc_PrintLines(nDocID,1,"To brew healing or mana extracts or elixirs, you need to additionally add a plant to the mixture:");
...
func void Use_BookstandALCHEMY3_S1()
{
	...
	if(Hlp_GetInstanceID(self) == Hlp_GetInstanceID(her))
	{
		...
		Doc_PrintLine(nDocID,0,"5 healing roots");
		Doc_PrintLine(nDocID,0,"");
