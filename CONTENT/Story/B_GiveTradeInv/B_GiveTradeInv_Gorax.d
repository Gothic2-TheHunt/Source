...
var int Gorax_ItemsGiven_JoinGuild;
...
func void B_GiveTradeInv_Gorax(var C_Npc slf)
{
	if((Kapitel >= 1) && (Gorax_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		CreateInvItems(slf,ItSc_InstantFireball,4);
	...
	if((Kapitel >= 1) && (Gorax_ItemsGiven_JoinGuild == FALSE) && hero.guild != GIL_NONE)
	{
		...
		Gorax_ItemsGiven_JoinGuild = TRUE;
	};
	if((Kapitel >= 2) && (Gorax_ItemsGiven_Chapter_2 == FALSE))
	{
		...
		CreateInvItems(slf,ItMW_Addon_Stab04,2);
	...
	{
		CreateInvItems(slf,ItMi_Gold,100);
		CreateInvItems(slf,ItMi_Flask,23);
		CreateInvItems(slf,ItMi_Sulfur,2);
		CreateInvItems(slf,ItMi_Quartz,2);
	...
	if((Kapitel >= 4) && (Gorax_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		CreateInvItems(slf,ItMi_Flask,21);
	...
	if((Kapitel >= 5) && (Gorax_ItemsGiven_Chapter_5 == FALSE))
	{
		...
		CreateInvItems(slf,ItMi_Flask,26);
