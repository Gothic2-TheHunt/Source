...
var int Constantino_ItemsGiven_JoinGuild;
...
func void B_GiveTradeInv_Constantino(var C_Npc slf)
{
	if((Kapitel >= 1) && (Constantino_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		CreateInvItems(slf,ItMi_Flask,14);
		...
		CreateInvItems(slf,ItPo_Perm_LittleHealth,1);
	...
	if((Kapitel >= 1) && (Constantino_ItemsGiven_JoinGuild == FALSE) && hero.guild != GIL_NONE)
	{
		CreateInvItems(slf,ItMi_Gold,31);
		CreateInvItems(slf,ItMi_Flask,18);
		...
		Constantino_ItemsGiven_JoinGuild = TRUE;
	};
	if((Kapitel >= 2) && (Constantino_ItemsGiven_Chapter_2 == FALSE))
	{
		...
		CreateInvItems(slf,ItPl_Mushroom_01,8);
	...
	if((Kapitel >= 4) && (Constantino_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		CreateInvItems(slf,ItMi_Flask,28);
		CreateInvItems(slf,ItPl_Temp_Herb,3);
	...
	if((Kapitel >= 5) && (Constantino_ItemsGiven_Chapter_5 == FALSE))
	{
		...
		CreateInvItems(slf,ItPl_SwampHerb,2);
		CreateInvItems(slf,ItPo_Health_01,9);
